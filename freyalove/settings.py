# Django settings for freyalove project.
...
SECRET_KEY = '#6+c@hhuonvz+4+rc^0hj9p8l#%20fmybuj$)1s#uc)*^y+cl3'
...
ROOT_URLCONF = 'freyalove.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'freyalove.wsgi.application'
