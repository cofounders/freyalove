...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.unread'
        db.add_column('conversations_conversation', 'unread',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.unread'
        db.delete_column('conversations_conversation', 'unread')
