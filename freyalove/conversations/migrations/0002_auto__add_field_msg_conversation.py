...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Msg.conversation'
        db.add_column('conversations_msg', 'conversation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['conversations.Conversation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Msg.conversation'
        db.delete_column('conversations_msg', 'conversation_id')
