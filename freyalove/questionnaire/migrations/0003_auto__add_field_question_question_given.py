...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.question_given'
        db.add_column('questionnaire_question', 'question_given',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.question_given'
        db.delete_column('questionnaire_question', 'question_given')
    ...
    models = {
        ...
        'questionnaire.question': {
            ...
            'question_given': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
