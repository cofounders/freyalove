...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SexyTime.initial_signal'
        db.add_column('matchmaker_sexytime', 'initial_signal',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SexyTime.initial_signal'
        db.delete_column('matchmaker_sexytime', 'initial_signal')
