...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatchProposal'
        db.create_table('matchmaker_matchproposal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from', to=orm['users.Profile'])),
            ('to_profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to', to=orm['users.Profile'])),
        ...
        db.send_create_signal('matchmaker', ['MatchProposal'])


    def backwards(self, orm):
        # Deleting model 'MatchProposal'
        db.delete_table('matchmaker_matchproposal')
