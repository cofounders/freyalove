...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.matchmaker_score'
        db.add_column('users_profile', 'matchmaker_score',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.matchmaker_score'
        db.delete_column('users_profile', 'matchmaker_score')
