...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FriendsCache'
        db.create_table('users_friendscache', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fb_ids', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.send_create_signal('users', ['FriendsCache'])


    def backwards(self, orm):
        # Deleting model 'FriendsCache'
        db.delete_table('users_friendscache')
    ...
    models = {
        ...
        'users.friendship': {
            ...
            'added': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)'}),
