...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_matchmaker'
        db.add_column('users_profile', 'is_matchmaker',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.is_matchmaker'
        db.delete_column('users_profile', 'is_matchmaker')
