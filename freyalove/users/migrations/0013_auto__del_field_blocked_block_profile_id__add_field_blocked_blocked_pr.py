...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Blocked.block_profile_id'
        db.delete_column('users_blocked', 'block_profile_id')

        # Adding field 'Blocked.blocked_profile'
        db.add_column('users_blocked', 'blocked_profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='blocked', to=orm['users.Profile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Blocked.block_profile_id'
        db.add_column('users_blocked', 'block_profile_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Deleting field 'Blocked.blocked_profile'
        db.delete_column('users_blocked', 'blocked_profile_id')
    ...
    models = {
        ...
        'users.friendship': {
            ...
            'added': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 24, 0, 0)'}),
